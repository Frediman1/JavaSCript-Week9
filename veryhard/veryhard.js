...
class programmer1 extends person1 {
    ...
    offerNewtask() {
        if (this.busy === true) {
            ...
            console.log(`${this.name} would love to take on New Task`)
...
const techProgrammer1 = new programmer1('Fredrick', 'Scientist', 23, ['Html', 'Css', 'Javascript', 'Krio', 'English']);
const techProgrammer2 = new programmer1('Artea', 'Developer', 25, ['Css', 'Javascript', 'Html', 'React'], false);
